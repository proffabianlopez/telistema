                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="full_name_client" value="<?php echo isset($row['client_name']) && isset($row['client_lastname']) ? $row['client_name'] . ' ' . $row['client_lastname'] : ''; ?>" readonly>
                                    </div>
                                    <input type="hidden" name="id_client" value="<?php echo $row['id_client'] ?? ''; ?>">
                                    <input type="hidden" name="technic_id" value="<?php echo $row['technic_id'] ?? ''; ?>">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control validate-field vtextarea" id="order_description" name="order_description" style="resize: none; max-width: 100%;" readonly><?php echo $row['order_description'] ?? ''; ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control validate-field vaddress" id="address" name="address" value="<?php echo $row['address'] ?? ''; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="height">Altura</label>
                                        <input type="number" class="form-control validate-field vhousenumber" id="height" name="height" value="<?php echo $row['height'] ?? ''; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="floor">Piso</label>
                                        <input type="text" class="form-control validate-field vfloor_dep" id="floor" name="floor" value="<?php echo $row['floor'] ?? ''; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="departament">Departamento</label>
                                        <input type="text" class="form-control validate-field vfloor_dep" id="departament" name="departament" value="<?php echo $row['departament'] ?? ''; ?>" readonly>
                                    </div>
                                </div>
                            </div>
