                                ...
                                <form class="mx-5" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="smtp_host" name="smtp_host"
                                            ...
                                            title="Ingrese el nombre del servidor SMTP que se utiliza para enviar correos electrónicos.">
                                    </div>
                                    <div class="form-group">
                                        <label for="smtp_port">Puerto SMTP</label>
                                        <input type="number" class="form-control" id="smtp_port" name="smtp_port"
                                            value="<?php echo htmlspecialchars($smtp_port); ?>"
                                            title="Ingrese el número de puerto que utiliza el servidor SMTP. Por lo general, es 25, 465 o 587.">
                                    </div>
                                    <div class="form-group">
                                        <label for="smtp_user">Usuario SMTP</label>
                                        <input type="text" class="form-control" id="smtp_user" name="smtp_user"
                                            value="<?php echo htmlspecialchars($smtp_user); ?>"
                                            title="Ingrese el nombre de usuario para autenticarse en el servidor SMTP.">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="smtp_pass" name="smtp_pass"
                                                ...
                                                title="Ingrese la contraseña asociada al usuario SMTP.">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="smtp_setfrom" name="smtp_setfrom"
                                            value="<?php echo htmlspecialchars($smtp_setfrom); ?>"
                                            title="Ingrese la dirección de correo electrónico desde la cual se enviarán los correos electrónicos.">
                                    </div>
                                    <div class="form-group">
                                        <label for="smtp_addaddress">Correo electrónico de recibo</label>
                                        <input type="email" class="form-control" id="smtp_addaddress"
                                            name="smtp_addaddress"
                                            value="<?php echo htmlspecialchars($smtp_addaddress); ?>"
                                            title="Ingrese la dirección de correo electrónico a la cual se enviarán las respuestas o notificaciones.">
                                    </div>
                                    <div class="form-group">
                                        <label for="pagina_web">Enlace de tu página</label>
                                        <input type="text" class="form-control" id="pagina_web" name="pagina_web"
                                            value="<?php echo htmlspecialchars($pagina_web); ?>"
                                            title="Ingrese la URL de su página web.">
                                    </div>
                                    <button type="submit" class="btn btn-danger btn-block"
                                        name="emailupdate">Actualizar</button>
