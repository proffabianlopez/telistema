        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                ...
                <div class="p-xxs font-italic bg-muted border-top-bottom text ">
                    <spn class="font-bold">NOTA:</spn> Al agregar un nuevo Técnico se enviará al email las
...
<script>
    $(document).ready(function() {
        $('#change-admin-form').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'techniciansController.php?token=<?php echo $token; ?>&action=add_technic', // La URL de tu archivo PHP
                data: formData,
                dataType: 'json',
