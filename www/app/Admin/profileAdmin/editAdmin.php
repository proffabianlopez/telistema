...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-body">
                    <form id="change-editadmin-form" role="change-editadmin-form" action="" method="POST">
    ...
    <script>
      ...
      document.getElementById('change-editadmin-form').addEventListener('submit', function(event) {
