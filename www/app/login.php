    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-success block full-width m-b">Inciar Sessión</button>
                <?php if(isset($msg)) {echo $msg; } ?>

            </form>
            <a  class="btn btn-primary block full-width m-b" href="../index.html">Volver a la página</a>
        </div>
    </div>
